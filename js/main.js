...
const Alert = (($) => {
  ...
  class Alert {
    ...
    _getRootElement(element) {
      const selector = __WEBPACK_IMPORTED_MODULE_1__util__["default"].getSelectorFromElement(element)
      let parent     = false
    ...
    _removeElement(element) {
      ...
      if (!__WEBPACK_IMPORTED_MODULE_1__util__["default"].supportsTransitionEnd() ||
      ...
      $(element)
        .one(__WEBPACK_IMPORTED_MODULE_1__util__["default"].TRANSITION_END, (event) => this._destroyElement(element, event))
...
throw new Error("Module parse failed: Unexpected token (219:8)\nYou may need an appropriate loader to handle this file type.\n|     _getConfig(config) {\n|       config = {\n|         ...Default,\n|         ...config\n|       }");

/***/ }),
/* 5 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (278:8)\nYou may need an appropriate loader to handle this file type.\n|     _getConfig(config) {\n|       config = {\n|         ...Default,\n|         ...config\n|       }");
...
throw new Error("Module parse failed: Unexpected token (223:8)\nYou may need an appropriate loader to handle this file type.\n|     _getConfig(config) {\n|       config = {\n|         ...Default,\n|         ...config\n|       }");
...
throw new Error("Module parse failed: Unexpected token (167:8)\nYou may need an appropriate loader to handle this file type.\n|     _getConfig(config) {\n|       config = {\n|         ...Default,\n|         ...config\n|       }");
...
const Tab = (($) => {
  ...
  class Tab {
    ...
    show() {
      ...
      const selector = __WEBPACK_IMPORTED_MODULE_1__util__["default"].getSelectorFromElement(this._element)
    ...
    _activate(element, container, callback) {
      ...
      const isTransitioning = callback &&
        __WEBPACK_IMPORTED_MODULE_1__util__["default"].supportsTransitionEnd() &&
...
throw new Error("Module parse failed: Unexpected token (497:10)\nYou may need an appropriate loader to handle this file type.\n|       if (this.config.selector) {\n|         this.config = {\n|           ...this.config,\n|           trigger: 'manual',\n|           selector: ''");
...
var _sitemap = __webpack_require__(17);
...
var _img = __webpack_require__(20);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Alert", function() { return __WEBPACK_IMPORTED_MODULE_1__alert__["default"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Button", function() { return __WEBPACK_IMPORTED_MODULE_2__button__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_3__carousel__, "default")) __webpack_require__.d(__webpack_exports__, "Carousel", function() { return __WEBPACK_IMPORTED_MODULE_3__carousel__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_4__collapse__, "default")) __webpack_require__.d(__webpack_exports__, "Collapse", function() { return __WEBPACK_IMPORTED_MODULE_4__collapse__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_5__dropdown__, "default")) __webpack_require__.d(__webpack_exports__, "Dropdown", function() { return __WEBPACK_IMPORTED_MODULE_5__dropdown__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_6__modal__, "default")) __webpack_require__.d(__webpack_exports__, "Modal", function() { return __WEBPACK_IMPORTED_MODULE_6__modal__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_7__popover__, "default")) __webpack_require__.d(__webpack_exports__, "Popover", function() { return __WEBPACK_IMPORTED_MODULE_7__popover__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_8__scrollspy__, "default")) __webpack_require__.d(__webpack_exports__, "Scrollspy", function() { return __WEBPACK_IMPORTED_MODULE_8__scrollspy__["default"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Tab", function() { return __WEBPACK_IMPORTED_MODULE_9__tab__["default"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_10__tooltip__, "default")) __webpack_require__.d(__webpack_exports__, "Tooltip", function() { return __WEBPACK_IMPORTED_MODULE_10__tooltip__["default"]; });
...
exports.default = function () {
  var Dropdown = (0, _jquery2.default)('nav .dropdown');
  ...
  var isDesktop = function isDesktop() {
    var maxWidth = (0, _jquery2.default)('body').data('grid-float-breakpoint-width') || 752;
    return (0, _jquery2.default)(document).width() > maxWidth || false;
  };
   ...
   */
  (0, _jquery2.default)('nav .nav-item').keydown(function (event) {
    var $next = (0, _jquery2.default)(this).next().find('a');
    var $prev = (0, _jquery2.default)(this).prev().find('a');
    switch (event.keyCode) {
      case 39:
        // forward [>]
        if ($next.length) {
   ...
   */
  (0, _jquery2.default)('.main-nav .navbar-nav').on('click', '.navbar-touch-caret', function (event) {
    event.stopPropagation();
    event.preventDefault();

    var $parent = (0, _jquery2.default)(this).parent('.dropdown');
...
exports.default = function () {
    ...
    (0, _jquery2.default)('.maori').attr('lang', 'mi');

    (0, _jquery2.default)('.nonvisual-indicator').addClass('sr-only').removeClass('nonvisual-indicator');
};
...
exports.default = function () {
  ...
  function setSitemapData(pageId, data) {
    (0, _jquery2.default)('#children-' + pageId).html(data);
  }
  ...
  (0, _jquery2.default)('.sitemap-page').on('click', 'a.sitemap__collapse-action', function (e) {
    e.preventDefault();
  ...
  (0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.sitemap__collapse-action').removeAttr('aria-selected');
  });
};
...
exports.default = function () {
  (0, _jquery2.default)('article[data-highlight]').each(function () {
    var text = (0, _jquery2.default)(this).data('highlight');
    (0, _jquery2.default)(this).highlight(text, { element: 'mark', className: 'highlight' });
  });
};
...
exports.default = function () {
  (0, _jquery2.default)('input.number').on('keyup', function () {
    var value = (0, _jquery2.default)(this).val();
    (0, _jquery2.default)(this).val(value.replace(/[a-zA-Z]/g, ''));
  });

  /**
   * Apply a Bootstrap 3 form structure context to the jQuery validator plugin in userforms
   */
  (0, _jquery2.default)('.userform, .comments-holder-container form').each(function () {
    if (typeof (0, _jquery2.default)(this).validate === 'function') {
      var validatorSettings = (0, _jquery2.default)(this).validate().settings;

      validatorSettings.highlight = function (element) {
        (0, _jquery2.default)(element).closest('.form-group').addClass('has-error');
      };

      validatorSettings.unhighlight = function (element) {
        (0, _jquery2.default)(element).closest('.form-group').removeClass('has-error');
      };
  ...
  var $commentReplyLink = (0, _jquery2.default)('.comment-reply-link');

  $commentReplyLink.click(function () {
    (0, _jquery2.default)(this).attr('aria-expanded', function (i, val) {
      return val !== 'true';
    });
  });
};
...
exports.default = function () {
  (0, _jquery2.default)('#main img').addClass('img-responsive');

  (0, _jquery2.default)('#main div .captionImage.right').removeClass('right').addClass('pull-right');

  (0, _jquery2.default)('#main div .captionImage.left').removeClass('left').addClass('pull-left');

  (0, _jquery2.default)('#main div .captionImage.center').removeClass('center').addClass('center-block');

  (0, _jquery2.default)('#main img.center').removeClass('center').addClass('center-block');
};
